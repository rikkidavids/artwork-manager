Build 4.56 — Qt approve/embed prototype
...
- The Qt prototype now supports Approve + Embed for saved artwork candidates, with progress, optional backups, and post-embed verification.

Qt prototype branch

- A PySide6 queue/review prototype is available on the qt-prototype branch.
- It can browse the queue, preview current/candidate artwork, and Approve + Embed saved candidates.
...
- The stable Tk app remains the full app for Scan, Find Artwork, Convert/Save, bulk maintenance, and NAS worker settings.
